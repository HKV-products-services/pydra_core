...
class CommonFunctions():
    ...
    def is_coast(watersystem : WaterSystem) -> bool:
        ...
        """
        if watersystem in [WaterSystem.COAST_SOUTH, WaterSystem.COAST_CENTRAL, 
                           WaterSystem.COAST_NORTH, WaterSystem.COAST_DUNES,
                           WaterSystem.WADDEN_SEA_WEST, WaterSystem.WADDEN_SEA_EAST, 
    ...
    def is_lower_rivier(watersystem : WaterSystem) -> bool:
        ...
        """
        if watersystem in [WaterSystem.MEUSE_TIDAL, WaterSystem.RHINE_TIDAL,
