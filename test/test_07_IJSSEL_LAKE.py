...
def test_exc_freq_line_h():
    ...
    # Compare
    _excfreqs = np.array([1/10, 1/100, 1/1_000, 1/10_000, 1/100_000, 1/1_000_000])
    calc_h_zmonz = fl_h_zmonz.interpolate_exceedance_probability(_excfreqs)
    res_h_zmonz = np.array([0.6012617, 0.89149811, 1.22942988, 1.59466267, 1.96410966, 2.29767858])
    calc_h_monz = fl_h_monz.interpolate_exceedance_probability(_excfreqs)
    res_h_monz = np.array([0.88067023, 1.22164364, 1.53385229, 1.87439753, 2.23825322, 2.59632654])
